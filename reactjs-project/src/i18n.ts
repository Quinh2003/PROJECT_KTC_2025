      ...
      "dashboard": {
        ...
        "admin": {
          ...
          "userTable": {
            ...
            "errors": {
              "addUser": "Error adding new user. Please try again!",
              "updateUser": "Error updating user: {{error}}. Please try again!",
              "deleteUser": "Error deleting user. Please try again!"
            }
          }
        },
        "validation": {
      ...
      "dashboard": {
        "dispatcher": {
          ...
          "orders": {
            ...
            "pendingPackages": "Gói hàng chờ",
            "packagesDelivered": "Gói hàng đã giao",
        ...
        "fleet": {
          ...
          "validation": {
            "licensePlateMinLength": "Biển số xe phải có ít nhất 6 ký tự",
            "licensePlateMaxLength": "Biển số xe không được vượt quá 15 ký tự",
            "licensePlateFormat": "Biển số xe phải có cả số và chữ (VD: 30A-12345)",
            "mustBeNumber": "{{field}} phải là số hợp lệ",
            "mustBePositive": "{{field}} phải là số dương",
            "tooLarge": "{{field}} quá lớn",
            "notesMaxLength": "Ghi chú không được vượt quá 500 ký tự"
          },
          "form": {
        ...
        "admin": {
          ...
          "userTable": {
            ...
            "errors": {
              "addUser": "Lỗi khi thêm user mới. Vui lòng thử lại!",
              "updateUser": "Lỗi khi cập nhật user: {{error}}. Vui lòng thử lại!",
              "deleteUser": "Lỗi khi xóa user. Vui lòng thử lại!"
            }
          }
        },
        "validation": {
