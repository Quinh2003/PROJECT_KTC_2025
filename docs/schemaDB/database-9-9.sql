...
-- =====================================================================================
-- BẢNG QUAN HỆ NGƯỜI DÙNG - VAI TRÒ (MANY-TO-MANY)
-- =====================================================================================
...
-- Indexes cho bảng USER_ROLES (many-to-many relationship)
CREATE INDEX idx_user_roles_user ON user_roles(user_id) COMMENT 'User roles theo người dùng';
CREATE INDEX idx_user_roles_role ON user_roles(role_id) COMMENT 'User roles theo vai trò';
